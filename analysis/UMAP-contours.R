...
# Script: figure 4 - Melodic Contours
################################################################################
...
# data
data_melodies <- read_csv("data/final-data/sing-scales-v2/data-sing-scales-v2_full_tonality.csv")
...
ggsave(paste0("results/figure4/UMAP_clusters_k4.png"),
       height = 12, width = 12,
       units = "cm", bg = "white",
       dpi=300)
...
ggsave(paste0("results/figure4/UMAP_clusters_sd.png"),
       plot_clusters,
       height = 8, width = 12,
       units = "cm",
       dpi=300)
...
ggsave(paste0("results/figure4/UMAP_clusters_mode.png"),
       height = 8, width = 16,
       units = "cm", bg = "white",
       dpi=300)
